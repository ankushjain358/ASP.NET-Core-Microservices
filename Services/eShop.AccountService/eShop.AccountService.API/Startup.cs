...
namespace eShop.AccountService.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "eShop Account Service API", Version = "v1" });
            });
            ...
            services.AddDbContext<eShopAccountsContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));

            // 7. Register interfaces for dependency injection
            services.AddScoped<IUnitOfWork, UnitOfWork>();
            services.AddScoped<IAccountService, Service.AccountService>();
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "eShop Account Service API - v1");
